...
describe('Message', function () {
  it('should be vaild IP address message', function () {
    // [data example] https://en.bitcoin.it/wiki/Protocol_documentation#Network_address
  ...
  it('should be vaild version message', function () {
    // [data example] https://en.bitcoin.it/wiki/Protocol_documentation#version, different port = 8333 instead of 0
  ...
  it('should be vaild verack message', function () {
    // [data example] https://en.bitcoin.it/wiki/Protocol_documentation#verack
  ...
  it('should be valid getheaders message', function () {
    // [data example] https://bitcoin.org/en/developer-guide#headers-first
